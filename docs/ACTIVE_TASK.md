...
2026-09-12报告页码一致性本地修复完成：Word报告导出优先使用渲染页码映射，后端无映射时回退原始页码；报告契约4 passed，前端lint/build通过，本机LibreOffice渲染新报告2页未见裁切/重叠。腾讯云正式1.5.2尚未部署该修复，云端报告仍显示原始第1页；待负责人另行授权部署。
